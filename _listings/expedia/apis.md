...
- name: Expedia Mobile Image
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/airports/master/_listings/expedia/api-mobile-image-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/airports/master/_listings/expedia/api-mobile-image-get-postman.md
x-common:
- type: x-base
